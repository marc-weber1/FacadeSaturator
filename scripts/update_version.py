...
def main():
  ...
  plistpath = scriptpath + "/resources/FacadeTest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FacadeTest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FacadeTest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FacadeTest-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FacadeTest-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FacadeTest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FacadeTest.iss",inplace=1):
