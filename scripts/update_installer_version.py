...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FacadeTest Demo Installer\n"
      else:
        line="OutputBaseFilename=FacadeTest Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FacadeTest Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FacadeTest installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FacadeTest Demo installer\n"
     else:
       line="SetupWindowTitle=FacadeTest installer\n"
